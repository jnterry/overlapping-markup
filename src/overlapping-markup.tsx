 ...
 */
export interface ContentRendererProps<TStyleData = any, TState extends ComponentState = ComponentState> {
	/**
...
function _generateElements(
	...
	setComponentState: React.Dispatch<React.SetStateAction<ComponentStateMap>>,
	...
	let props: ContentRendererProps = {
		styleData: root.data,
		state: {},
		setState: () => { },
	};
...
export const OverlappingMarkup: (
	...
	let [componentState, setComponentState] = React.useState<ComponentStateMap>({});
